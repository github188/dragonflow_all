...
public class DeviceTelnetDialogs extends Dialog {
	String ip;
	String community;
	int port;
	int nver;
	...
	public DeviceTelnetDialogs(Shell parentShell, String typetable, String tag, String nodeid) {
		super(parentShell);
...
//			UICallBack.runNonUIThreadWithFakeContext(display, new Runnable() {
			RWT.getUISession().exec(new Runnable() {
				...
				public void run() {
					...
					String command = "telnet " + serverAddress;
