...
public class DevicePingDialog extends Dialog {
	String ip;
	String community;
	int port;
	int nver;
	...
	public DevicePingDialog(Shell parentShell, String typetable, String tag, String nodeid) {
		super(parentShell);
