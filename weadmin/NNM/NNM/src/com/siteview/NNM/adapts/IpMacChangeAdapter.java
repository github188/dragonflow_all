...
public class IpMacChangeAdapter implements IWorkbenchAdapter, IWorkbenchAdapter2{
	...
	public ImageDescriptor getImageDescriptor(Object object) {
		...
		ImageDescriptor temp=AbstractUIPlugin.imageDescriptorFromPlugin(
				Activator.PLUGIN_ID, ImageKeys.IPMAC);
		return temp;
	}
	...
	public String getLabel(Object o) {
		// TODO Auto-generated method stub
		if(o instanceof IpMacChangeModle)
			return ((IpMacChangeModle) o).getName();
		return "";
	}
