...
public class CIM_FCPort
{
  ...
  private Set<CIM_FCPortStatistics> cim_FCPortStatisticsSwitch = new HashSet();
  ...
  public void setCim_ComputerSystemController(Set<CIM_ComputerSystemController> cim_ComputerSystemController) {
  ...
  public Set<CIM_FCPortStatistics> getCim_FCPortStatistics()
  {
    return this.cim_FCPortStatistics;
  }

  public void setCim_FCPortStatistics(Set<CIM_FCPortStatistics> cim_FCPortStatistics)
  {
    this.cim_FCPortStatistics = cim_FCPortStatistics;
  }

  public Set<CIM_LogicalPortGroup> getCim_LogicalPortGroup()
  {
    return this.cim_LogicalPortGroup;
  }

  public void setCim_LogicalPortGroup(Set<CIM_LogicalPortGroup> cim_LogicalPortGroup)
  {
  ...
  public Set<CIM_FCPortStatistics> getCim_FCPortStatisticsSwitch() {
    return this.cim_FCPortStatisticsSwitch;
  }

  public void setCim_FCPortStatisticsSwitch(Set<CIM_FCPortStatistics> cim_FCPortStatisticsSwitch)
  {
    this.cim_FCPortStatisticsSwitch = cim_FCPortStatisticsSwitch;
  }
}
