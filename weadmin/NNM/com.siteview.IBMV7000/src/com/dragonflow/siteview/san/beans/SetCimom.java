...
public class SetCimom
{
  ...
  public SetCimom(String providerName, String protocol, String ipAddress, int port, String cimomNamespace, String cimomInteropNamespace, String username, String password, int discoveryInterval, int dataRetention)
  {
