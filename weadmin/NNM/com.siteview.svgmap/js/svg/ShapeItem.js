...
*  fill-opacity Í¸Ã÷
*  <text>  fontname  fontsize textanchor ¶ÔÆë
*shapeitem
********************************************/
d3svgmap.ShapeItem = function( parent ) {
  this._parent = parent;
  this._value = "";
  this._linewidth = 1;
  this._fillcolor = "";
...
rap.registerTypeHandler( "d3svgmap.ShapeItem", {

  factory: function( properties ) {
    var parent = rap.getObject( properties.parent );
    return new d3svgmap.ShapeItem( parent );
  },
