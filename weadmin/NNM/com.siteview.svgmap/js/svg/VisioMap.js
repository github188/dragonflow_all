...
d3svgmap.VisioMap = function (parent) {
	this._barWidth = 25;
	this._spacing = 2;
	this._items = new d3svgmap.ItemList();
	this._svgMap = new d3svgmap.SvgMap(parent, this);
	...
	this._selectnodeid = "";
	this._statuss = []; // 状态 (默认)0 down 1 up 2  Testing 3 Alarm 4 Other  5 Unknown
};

d3svgmap.VisioMap.prototype = {
...
rap.registerTypeHandler("d3svgmap.VisioMap", {

	factory : function (properties) {
		var parent = rap.getObject(properties.parent);
		return new d3svgmap.VisioMap(parent);
	},
